...
/** Google's official multi-color "G" mark, per Google's brand guidelines for third-party sign-in buttons. */
export function GoogleLogoColored({ size = 20 }: { size?: number }) {
  return (
