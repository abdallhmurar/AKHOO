...
// separately here and looked up below. Mirrors WantToHelpCard.web.tsx.
const VIDEO_BY_LOCALE: Record<Locale, number> = {
  ar: require("./want-to-help-video-ar.mp4"),
  he: require("./want-to-help-video-he.mp4"),
  en: require("./want-to-help-video-en.mp4"),
};

/** Same pattern as HelpCardLottie.tsx: text is baked into each per-language video, no overlay. */
